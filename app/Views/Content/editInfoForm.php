...
<div class="row justify-content-center">
    <div class="homeContainer col-10">
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="text" id="icon<?= $i ?>" class="form-control" value="<?= old('icon' . $i, esc($features[$i - 1]["icon"])) ?>" placeholder="Enter icon class">
                                        </div>
                                        <div class="mb-3">
                                            <label for="feature_heading<?= $i ?>" class="form-label">Feature Heading</label>
                                            <input type="text" id="feature_heading<?= $i ?>" class="form-control" value="<?= old('feature_heading' . $i, esc($features[$i - 1]["feature_heading"])) ?>" placeholder="Enter heading">
                                        </div>
