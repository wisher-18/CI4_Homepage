<div class="mb-3">
    ...
    <input type="text" name="content_title" id="content_title" class="form-control"
        placeholder="Enter title of the content" value="<?= old("content_title", esc($content->content_title)) ?>">
</div>
<div class="mb-3">
...
<div class="mb-3">
    ...
    <?php if (!empty($content->content_image)): ?>
        <img src="<?= base_url('public/content_images/' . $content->content_image); ?>" alt="Previous Image" class="mb-2"
...
<div class="mb-3">
    ...
    <input type="text" name="content_section" id="content_section" class="form-control"
        value="<?= old("content_section", esc($content->content_section)) ?>" placeholder="features/hero/other_section">
</div>
<div class="mb-3">
...
<div class="mb-3">
    <label for="primary_btn" class="form-label">Need primary button?
        <input type="radio" name="primary_btn" value="yes" <?= set_radio('primary_btn', 'yes', old('primary_btn', $content->primary_btn === 'yes')); ?> onchange="toggleUrlInput('primary_btn_url', this.value)" /> Yes
        <input type="radio" name="primary_btn" value="no" <?= set_radio('primary_btn', 'no', old('primary_btn', $content->primary_btn === 'no')); ?> onchange="toggleUrlInput('primary_btn_url', this.value)" /> No
    </label>
...
<div class="mb-3">
    <label for="secondary_btn" class="form-label">Need secondary button?
        <input type="radio" name="secondary_btn" value="yes" <?= set_radio('secondary_btn', 'yes', old('primary_btn', $content->primary_btn === 'yes')); ?> onchange="toggleUrlInput('secondary_btn_url', this.value)" /> Yes
        <input type="radio" name="secondary_btn" value="no" <?= set_radio('secondary_btn', 'no', old('primary_btn', $content->primary_btn === 'no')); ?> onchange="toggleUrlInput('secondary_btn_url', this.value)" /> No
    </label>
...
<div class="mb-3">
    ...
    <?php if (!empty($content->background_img)): ?>
        <img src="<?= base_url('public/content_images/' . $content->background_img); ?>" alt="Background Image" class="mb-2"
            style="max-width: 200px; max-height: 200px;">
